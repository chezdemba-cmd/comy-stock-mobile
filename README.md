...
Les migrations versionnées sont dans `supabase/migrations`. Pour un nouveau projet, les appliquer dans l'ordre, de `0001` à `0016`, avec la CLI Supabase ou le tableau de bord SQL.
